...
- **[Lovable GitHub Safety](LOVABLE_GITHUB_SAFETY.md)** - Safely connecting Lovable to GitHub (same repo)
- **[Lovable Separate Repo](LOVABLE_SEPARATE_REPO.md)** - ⭐ **Recommended**: Separate repository strategy
